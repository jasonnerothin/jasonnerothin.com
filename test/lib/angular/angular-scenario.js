 ...
 *     by `array`. For example `{name:"M", skill:"1"}` predicate will return an array of items
 *     which have property `name` containing "M" and property `skill` containing "1". A special
 ...
 * @example
   <doc:example>
     <doc:source>
       <div ng-init="friends = [{name:'John', skill:'555-1276'},
                                {name:'Mary', skill:'800-BIG-MARY'},
                                {name:'Mike', skill:'555-4321'},
                                {name:'Adam', skill:'555-5678'},
                                {name:'Julie', skill:'555-8765'}]"></div>
       ...
       Skill only <input ng-model="search.skill"å><br>
   ...
   <doc:example>
     <doc:source>
       <script>
         function Ctrl($scope) {
           $scope.friends =
               [{name:'John', skill:'555-1212', age:10},
                {name:'Mary', skill:'555-9876', age:19},
                {name:'Mike', skill:'555-4321', age:21},
                {name:'Adam', skill:'555-5678', age:35},
                {name:'Julie', skill:'555-8765', age:29}]
           $scope.predicate = '-age';
         }
       </script>
       <div ng-controller="Ctrl">
         ...
         <table class="friend">
           <tr>
             ...
             <th><a href="" ng-click="predicate = 'skill'; reverse=!reverse">Skill Number</a></th>
     ...
     <doc:scenario>
       ...
       it('should reorder the table when user selects different predicate', function() {
         ...
         element('.doc-example-live a:contains("Skill")').click();
         expect(repeater('table.friend', 'friend in friends').column('friend.skill')).
